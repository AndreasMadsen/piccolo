  ...
  this.domain.run((function () {
    ...
    // direct piccolo request
      ...
      if (this.piccolo.get('debug')) {
        console.log('got direct piccolo request:', this.url.href);
      }
    ...
    // change table request
      ...
      if (this.piccolo.get('debug')) {
        console.log('got change table request:', this.url.href);
      }
    ...
    // static file request
      ...
      if (this.piccolo.get('debug')) {
        console.log('got static file request:', this.url.href);
      }
...
Request.prototype.matchPresenter = function () {
  ...
  this.cache.filepath = path.resolve('/', this.cache.route.path);
...
Request.prototype.send = function (file) {
  ...
  file.once('ready', function () {
    ...
    console.log(req.headers['if-none-match'], file.etag);
...
Request.prototype.handleError = wrap(function () {
  ...
  if (typeof router.error === 'function') {
    ...
    if (this.piccolo.build.presenter.exist(this.cache.filepath)) {
