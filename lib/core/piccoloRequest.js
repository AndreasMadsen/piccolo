...
requestHandlers['require'] = function () {
  ...
  var rootname = this.url.query.root;
  if (typeof modulename !== 'string' || typeof rootname !== 'string') {
    return deniedAcess(this);
  }
  ...
  var file = this.piccolo.build.dependencies.readClient(rootname, modulename, cache);
  this.send(file);
};
