...
var modules = common.load('modules', 'module.server');
...
Piccolo.prototype.require = function (filename /*, dirrectly, callback */) {
  var callback = arguments[arguments.length - 1];
  var dirrectly = arguments.length === 3 ? arguments[2] : undefined;
...
Piccolo.prototype.build = function () {
  ...
  async.parallel({
    ...
    modules: dependencies.bind(null, self)
