...
events.EventEmitter.prototype.emit = function (eventName) {
  if ((this === process || this === process.stdout || this === process.stderr) === false) {
    if ((eventName === 'newListener') === false) {
...
Piccolo.prototype.build = function () {
  ...
  async.parallel({
    ...
    changeTable: directory.bind(null, this.get('presenter')),

    // build client core
    client: clientBuild.bind(this)
