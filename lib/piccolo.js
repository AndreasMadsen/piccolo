...
Piccolo.prototype.require = function () {
  this.build.main.require.apply(this.build.main, arguments);
};
...
Piccolo.prototype.build = function () {
  ...
  async.parallel({
    ...
    bindingSource: directoryContent.bind(null, common.find('bindings'), '.server.js'),
    moduleSource: directoryContent.bind(null, common.find('modules'), '.js')
