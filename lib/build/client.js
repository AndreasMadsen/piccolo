...
function ClientCore(callback) {
  if (!(this instanceof ClientCore)) return new ClientCore(callback);
  ...
  async.parallel({
    ...
    list.modules = list.modules
      ...
      .map(function (filepath) {
        var modulename = path.basename(filepath, ".js");
            modulename = path.basename(modulename, ".client");
    ...
    async.map(loadlist, loadfile, function (error, files) {
      ...
      for (i = 0; i < l; i++) {
        ...
        if (file.module) {
          file.wrapper = {
            start: 'NativeModule.' + file.module + ' = (function (exports, require) {\n',
            end: '  return exports;\n})({}, null);\n'
          };
