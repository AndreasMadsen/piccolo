...
function compileModule(piccolo) {
  ...
  requireWrap.binding = function (bindingname) {
    ...
    var source = wrapper[0] + bindingSource[bindingname] + wrapper[0];
    ...
    fn(binding.exports, require, binding, binding.filename);
  ...
  fn(module.exports, requireWrap, module, module.filename);
