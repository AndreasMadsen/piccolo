...
Module._resolveFilename = function(rootname, source, modulename) {
...
function moduleLoader(rootname) {
  return function (request, callback) {
    ...
    var cache = Object.keys(Module._cache[rootname]).concat(Object.keys(Module._source[rootname]));
    read(rootname, filename, cache, function (error, map) {
      ...
      // compile module
      callback(null, self._initCompile('modules', filename));
    });
  };
}
