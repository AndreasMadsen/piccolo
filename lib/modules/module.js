...
var compile = piccolo.binding('compile')
var read = piccolo.binding('read');
...
NativeModule._source = piccolo.binding('natives');
NativeModule._cache = {};
...
Module.prototype._compile = function(content, filename) {
  ...
  var args = [this.exports, require, this, this.filename, this.dirname];
